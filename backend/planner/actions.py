...
_SCENARIO_RISK_TITLES: dict[str, str] = {
    ...
    "solo_heavy_handling": "Ergonomic lift hazard: heavy cargo handled by single worker",
    "wrong_product_orientation": "Non-compliant package orientation against handling specification",
    "entity_in_dock_edge_zone": "Fall hazard: worker or equipment near unprotected dock ledge",
    "entity_in_wet_floor_zone": "Slip/skid hazard: operation within marked wet floor zone",
    ...
    "wrong_equipment_usage": "Equipment class mismatch for cargo handling specification",
